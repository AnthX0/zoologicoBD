...
public class PersonasDAO implements IPersonasDAO {
    ...
    public Persona agregar(Persona persona) {
        ...
        documentoPersona.append("fechaIngreso", 
    ...
    public List<Persona> consultarPersonas() {
        ...
        try (MongoCursor<Document> cursor = documentos.iterator()) {
            while (cursor.hasNext()) {
                ...
                // Crear una instancia de Persona y asignar los valores 
                // del documento
                Persona persona = new Persona();
                persona.setId(documento.getObjectId("_id"));
                persona.setNombre(documento.getString("nombre"));
                persona.setDireccion(documento.getList("direccion", 
                        String.class));
                persona.setTelefono(documento.getString("telefono"));
                persona.setFechaIngreso(documento.getDate(
                        "fechaIngreso"));
