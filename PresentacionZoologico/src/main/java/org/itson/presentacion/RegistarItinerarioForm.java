...
public class RegistarItinerarioForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextFieldZonas = new javax.swing.JTextField();
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabelZonas)
                    .addComponent(jTextFieldZonas, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButtonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGuardarActionPerformed
        ...
        float longitud = Float.parseFloat(jTextFieldLongitud.getText());
        int maxVisitantes = Integer.parseInt(jTextFieldMaxVisitantes.getText());
        LocalDateTime localDate = datePicker.getDateTimePermissive();
        Instant instant = localDate.atZone(
                ZoneId.systemDefault()).toInstant();
        Date date;
        // Obtener las zonas seleccionadas
        Zona zona = new Zona();
        zona.setNombre(jTextFieldZonas.getText());
        // Validar los campos
        if (nombre.isEmpty() || duracion <= 0 || longitud <= 0 || 
                maxVisitantes <= 0 || localDate.toLocalDate().equals(0) 
                || zona.getNombre().isEmpty()) {
            ...
            fachadaN.validacionDatosItinerario(
                    nombre, 
                    duracion, 
                    longitud, 
                    maxVisitantes, 
    ...
    private javax.swing.JTextField jTextFieldZonas;
